...
const AulaVerdePrecios: React.FC = () => {
  ...
  return (
    <section id="precios" className="py-16 md:py-24 px-6 bg-brand-green text-white rounded-3xl relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center" data-aos="fade-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto items-stretch">
          ...
          <div className="w-full h-full md:py-6 lg:py-10" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="w-full h-full z-10 md:-translate-y-4" data-aos="fade-up" data-aos-delay="200">
            <div className="relative flex flex-col bg-white rounded-2xl shadow-2xl p-6 lg:p-8 h-full" style={{ border: '4px solid #D4AF37' }}>
              ...
              <ul className="space-y-5 md:space-y-6 text-sm md:text-base text-left flex-grow mb-10" style={{ color: '#005333' }}>
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
                  <span>Propuesta Pedagogica completa con Talleres guiados (Huerta, Arte y otras dinámicas)</span>
                </li>
              </ul>
              <div className="mt-8 text-center mt-auto">
          ...
          <div className="w-full h-full md:py-6 lg:py-10" data-aos="fade-up" data-aos-delay="300">
        ...
        <div className="mt-12 text-center flex flex-col items-center" data-aos="zoom-in" data-aos-delay="100">
