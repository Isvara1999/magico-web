...
const AulaVerdePrecios: React.FC = () => {
  ...
  <div className="flex flex-col bg-transparent border border-green-700/50 rounded-2xl p-6 lg:p-8 h-full">
    {/* mt-6 baja el texto para alinearlo con la tarjeta central */}
    <div className="text-center mb-8 mt-6">
      <h3 className="text-xl font-bold text-white mb-2">Eco-Campamento Base</h3>
      <div className="text-3xl font-extrabold text-[#D4AF37] mb-1">Desde $65.000</div>
      <div className="text-sm text-green-100">por alumno / por día</div>
    </div>
    <ul className="space-y-4 text-sm md:text-base text-left text-white flex-grow">
      ...
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
        <span>Pensión completa (4 comidas)</span>
      </li>
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
  ...
  <div className="relative flex flex-col bg-white rounded-2xl shadow-2xl p-6 lg:p-8 h-full transform md:-translate-y-4 z-10" style={{ border: '4px solid #D4AF37' }}>
    ...
    <div className="text-center mb-8 mt-6">
      ...
      <div className="text-3xl md:text-4xl font-extrabold tracking-tight mb-1" style={{ color: '#D4AF37' }}>Desde $85.000</div>
      <div className="text-sm" style={{ color: '#005333' }}>por alumno / por día</div>
    </div>
    <ul className="space-y-4 text-sm md:text-base text-left flex-grow" style={{ color: '#005333' }}>
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
        <span className="font-bold">Todo lo del plan Base</span>
      </li>
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
      ...
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
        <span>Talleres guiados (Huerta, Arte, Fuego)</span>
      </li>
      <li className="flex items-start gap-3">
        <Check className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#D4AF37' }} />
  ...
  {/* TARJETA 3 - A MEDIDA (DISEÑO PREMIUM) */}
  <div className="flex flex-col rounded-2xl p-6 lg:p-8 h-full shadow-lg backdrop-blur-sm" style={{ backgroundColor: 'rgba(0, 0, 0, 0.20)', border: '1px solid rgba(212, 175, 55, 0.4)' }}>
    <div className="text-center mb-8 mt-6">
      ...
      {/* Texto personalizado con toque elegante */}
  ...
  {/* TEXTO LEGAL Y BOTÓN FINAL DE LA SECCIÓN */}
