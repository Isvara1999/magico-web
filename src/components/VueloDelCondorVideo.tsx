    ...
    <section className="py-24 md:py-36 px-6 bg-[#F4F3EF]">
      <div className="max-w-3xl mx-auto text-center" data-reveal>
        ...
        <p className="font-serif italic text-gray-600 text-xl md:text-3xl leading-relaxed md:leading-relaxed">
          "Hay momentos en la vida de un hombre en que el camino ya recorrido deja de ser suficiente. No porque haya fallado — sino porque es hora de ir más profundo para volar más alto."
        </p>
